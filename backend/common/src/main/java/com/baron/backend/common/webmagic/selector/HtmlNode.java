...
import com.baron.backend.common.webmagic.selector.AbstractSelectable;
import com.baron.backend.common.webmagic.selector.LinksSelector;
...
public class HtmlNode extends AbstractSelectable {
    ...
    protected Selectable selectElements(BaseElementSelector elementSelector) {
        ...
        if (!elementSelector.hasAttribute()) {
            ...
            return new com.baron.backend.common.webmagic.selector.HtmlNode(resultElements);
        } else {
    ...
    public List<Selectable> nodes() {
        ...
        for (Element element : getElements()) {
            ...
            selectables.add(new com.baron.backend.common.webmagic.selector.HtmlNode(childElements));
        }
        return selectables;
    }
