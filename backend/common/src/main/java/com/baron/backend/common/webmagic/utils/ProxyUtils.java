package com.baron.backend.common.webmagic.utils;
...
public class ProxyUtils {
	...
	private static final Logger logger = LoggerFactory.getLogger(com.baron.backend.common.webmagic.utils.ProxyUtils.class);
