...
public class PlainText extends AbstractSelectable {
    ...
    public static com.baron.backend.common.webmagic.selector.PlainText create(String text) {
        return new com.baron.backend.common.webmagic.selector.PlainText(text);
    }
    ...
    public List<Selectable> nodes() {
        ...
        for (String string : getSourceTexts()) {
            nodes.add(com.baron.backend.common.webmagic.selector.PlainText.create(string));
        }
        return nodes;
    }
