...
import com.baron.backend.common.webmagic.selector.ElementSelector;
import com.baron.backend.common.webmagic.selector.HtmlNode;
...
public class Html extends HtmlNode {
    ...
    public static com.baron.backend.common.webmagic.selector.Html create(String text) {
        return new com.baron.backend.common.webmagic.selector.Html(text);
    }
